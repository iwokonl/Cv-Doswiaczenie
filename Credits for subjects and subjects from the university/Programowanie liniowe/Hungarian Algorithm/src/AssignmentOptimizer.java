...
public class AssignmentOptimizer {
    ...
    public AssignmentOptimizer(int[][] costMatrix) {
    ...
    public static void main(String[] args) {
        ...
        AssignmentOptimizer optimizer = new AssignmentOptimizer(costMatrix);
        int[][] assignment = optimizer.optimize();
        System.out.printf("Optymalne rozwiązanie: %s%n", Arrays.deepToString(assignment));
        int temp = 0;
        ...
        System.out.printf("Całkowity koszt: %d%n", temp);
    }
}